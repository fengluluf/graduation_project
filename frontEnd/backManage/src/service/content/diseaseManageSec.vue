<template>
    <div class="diseaseManageSec">
        <div class="diseaseManageSec-header">
            <ul>
                <li>
                    <span>修改时间</span>
                    <el-date-picker
                ...
                <li>
                    <span>疾病一级分类</span>
                    <el-select v-model="searchData.diseaseSortFir" placeholder="请选择" size="small">
                        <el-option
                ...
                <li>
                    <span>疾病二级分类</span>
                    <el-input size="small" v-model="searchData.diseaseSortSec" placeholder="请输入内容"></el-input>
                </li>
                <li>
                    <el-button type="primary" size="small" @click="userSearchHandler">搜索</el-button>
                </li>
                <li>
                    <el-button type="success" size="small" @click="addDiseaseHandler">添加疾病分类</el-button>
                </li>
            </ul>
        </div>
        <div class="diseaseManageSec-con">
            <div class="allDelete">
            ...
            <el-table v-model="loading" :data="tableData" style="width: 100%" border stripe size="small" @selection-change="handleSelectionChange" :height="tableListHeight">
                ...
                <el-table-column align="center" prop="diseaseSortF" label="疾病一级分类名称" width="180"></el-table-column>
                <el-table-column align="center" prop="diseaseSortS" label="疾病二级分类名称" width="180"></el-table-column>
        ...
        <el-dialog title="添加疾病" :visible.sync="dialogAddSSort" :before-close="handleClose">
            <div class="disease-content-dialog">
                <ul>
                    <li>
                        <span class="content-title">一级分类</span>
                        <el-select v-model="disease.diseaseSortFir" placeholder="请选择" size="small">
                    ...
                    <li>
                        ...
                        <el-input type="text" size="small" placeholder="请输入内容" v-model="disease.diseaseSortSec"> </el-input>
                    </li>
                </ul>
            </div>
...
export default {
    ...
    data () {
        return {
            ...
            loading:true,//表格加载
            diseaseOptionsFir:{},//疾病一级分类
            dialogAddSSort:false,//是否显示添加弹窗
            disease:{diseaseSortFir:'',diseaseSortSec:''},
        }
    },
    created(){
        this.getTableData();
    ...
    methods:{
        //设置表格高度
        resizeTableHeight1() {
            let searchDiv = document.querySelector('.diseaseManageSec-header');
...
<style scoped>
.diseaseManageSec-header ul {
    list-style: none;
    overflow: auto;
}
.diseaseManageSec-header ul li {
  float: left;
  padding-right: 20px;
  line-height: 40px;
}
.diseaseManageSec-header ul li .el-input {
  display: inline-block !important;
  width: 200px !important;
}
.diseaseManageSec-con{
    margin-top:10px;
}
.diseaseManageSec-con .allDelete{
    float: right;
    margin-bottom: 5px;
}
.diseaseManageSec-con .text-danger{
  color: #F56C6C;
}
.diseaseManageSec-con .text-danger.is-disabled{
  color: #c0c4cc;
}
.el-pagination{
    position: absolute;
